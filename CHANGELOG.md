...
- [`a1cb36d`](https://github.com/tufantunc/ssh-mcp/commit/a1cb36d88a152f25e49d373e2a5cc5ba840120a5) Thanks [@claude](https://github.com/claude)! - Ship an MCPB bundle (`ssh-mcp-<version>.mcpb`) as a release artifact, so Claude Desktop can install the server in one click instead of through a global npm install and a hand-edited `mcpServers` entry.
